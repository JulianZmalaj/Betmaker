            ...
            <header >
                    ...
                    <div className="content-main">
                        ...
                        <div className="top-header--right">
                            ...
                            <div className="language">
                                <div>
                                    <img src={
                                        english ? images['england'] : images['italy']
                ...
                <div className="bottom-header">
                    <div className="content-main">
                        ...
                        <div className="crazyHour">
                            ...
                            <div className="playtime">
                                ...
                                <div className="clock">
                                    ...
                                    </div><div className="clock--m">
                                        <span>M</span><span className="newSec">{new Date().getMinutes()}</span>
                                    </div>
                        ...
                        <nav>
                            <Link className="nav-item" to="/sport">Sport <span>{english ? 'New Style' : 'Nuovo stile'}</span></Link>
                            <Link className="nav-item" to="/live">Livebetting <span></span></Link>
                            <Link className="nav-item" to="/casino">Casino <span></span></Link>
                            <Link className="nav-item" to="/casino-live">{english ? 'Casino live ' : 'Casinò dal vivo'} <span>{english ? 'New' : 'Nuovo'}</span></Link>
                            <Link className="nav-item" to="/virtual">Virutal games<span>{english ? 'New' : 'Nuovo'}</span></Link>
                            <Link className="nav-item" to="/bonus">Bonus <span></span></Link>
                        </nav>
                    </div>
                </div>
